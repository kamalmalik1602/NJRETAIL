...
<div id="contact" class="contact-us section">
    <div class="cont">
      <div class="row">
        <div class="col-lg-12 wow fadeInUp animated" data-wow-duration="0.5s" data-wow-delay="0.25s" style={{visibility: "visible",animationDuration: "0.5s", animationDuration: "0.5s", animationDuration: "0.5s",animationDelay: "0.25s", animationDelay: "0.25s", animationDelay: "0.25s"}}>
           </div>
